...
fn load_test_images() -> std::io::Result<Vec<TestImage>> {
    Ok(vec![
        ...
        TestImage::raw_pad("test.nv12.pad.raw", RawImageEncoding::Nv12)?,
        TestImage::raw("test.nv12.raw", RawImageEncoding::Nv12)?,
...
// NV12: semi-planar YUV 4:2:0. Allow minor errors since the test data was generated by a different
// BT.709 implementation (Python) than the reference (yuv crate).
test!(
    test_nv12_yuv420,
    "test.nv12.raw",
    y_psnr = 54.,
...
#[test]
fn test_nv12_yuv420_padded() {
    test_yuv420_padded("test.nv12.raw");
}
