...
class PlotRightAxis(_BaseModel):
    """
    Configuration for the right y-axis in a Plot panel.
    """
...
class PlotSeries(_BaseModel):
    ...
    """
    Whether this series is plotted on the right y-axis. When false or unset, the series uses the left y-axis.
    """
