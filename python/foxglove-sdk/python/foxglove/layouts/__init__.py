...
class BaseRendererConfig(_BaseModel):
    ...
    """
    Synchronize images/video, annotations, scene entities, and voxel grids by exact timestamp
    """
...
class MapTopicSettings(_BaseModel):
    ...
    point_display_mode: (
        Literal["dot", "pin", "diamond", "square", "plus", "cross"] | None
    ) = None
    """
...
class UserScriptsPanel(BasePanel):
    ...
    For more information, see `the documentation <https://docs.foxglove.dev/docs/visualization/panels/user-scripts>`__.
