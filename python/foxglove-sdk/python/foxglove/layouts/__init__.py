...
class MarkdownConfig(_BaseModel):
    ...
    """
    FoxQL expression for a field containing Markdown text as a string.
    """
...
class StateTransitionsSeries(_BaseModel):
    ...
    value: str | None = None
    """
    FoxQL expression containing values for the series
    """

    label: str | None = None
    """
    Label displayed for the series
    """
    ...
    """
    FoxQL expression containing a timestamp field on the same topic as the value expression
    """
    ...
    """
    For dynamic sub-series from array-of-object messages: field name used as the sub-series identifier. Defaults to label.
    """
...
@dataclass(kw_only=True)
class PlotComparisonSlotOverride(_BaseModel):
    """
...
class PlotSeries(PlotSeriesBase):
    ...
    - customField is a FoxQL expression which can point to any field within the message data containing sec and nsec integers
...
class PlotConfig(_BaseModel):
    ...
    - Expression: numeric message fields for XY plots
...
class ImageModeConfig(_BaseModel):
    ...
    near: float | None = None
    """
    Near clipping plane distance for 3D content
    """

    far: float | None = None
    """
    Far clipping plane distance for 3D content
    """
...
class GaugeConfig(_BaseModel):
    ...
    path: str | None = None
    """
    FoxQL expression containing a numeric value (or string value that can be coerced to a numeric value)
    """
    ...
    """
    Value the fill grows from. Defaults to Min.
    """

    mirror_color_at_origin: bool = False
    """
    Mirror the color ramp at the origin (diverging look). Only used when origin is set.
    """
    ...
    def _to_dict(self) -> dict[str, Any]:
        return {
            ...
            "origin": self.origin,
            "mirrorColorAtOrigin": self.mirror_color_at_origin,
        }
...
class RawMessagesConfig(_BaseModel):
    ...
    """
    FoxQL expression to diff against
    """
