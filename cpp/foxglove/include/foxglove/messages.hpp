...
/// @brief A single chunk of a compressed audio bitstream
struct CompressedAudio {
  ...
  /// @brief Get the CompressedAudio schema.
  ///
  /// The schema data returned is statically allocated.
  static Schema schema();
};
...
struct CompressedPointCloud {
  ...
  /// @brief Get the CompressedPointCloud schema.
  ///
  /// The schema data returned is statically allocated.
  static Schema schema();
};
...
struct JointStates {
  ...
  /// @brief Encoded the JointStates as protobuf to the provided buffer.
  ///
  /// On success, writes the serialized length to *encoded_len.
  /// If the provided buffer has insufficient capacity, writes the required capacity to *encoded_len
  /// and returns FoxgloveError::BufferTooShort.
  ...
  /// @brief Get the JointStates schema.
  ///
  /// The schema data returned is statically allocated.
  static Schema schema();
};
...
/// @brief A channel for logging CompressedAudio messages to a topic.
///
/// @note While channels are fully thread-safe, the CompressedAudio struct is not thread-safe.
/// Avoid modifying it concurrently or during a log operation.
...
public:
  ...
  /// @param context The context which associates logs to a sink. If omitted, the default context is
  /// used.
  static FoxgloveResult<CompressedAudioChannel> create(
    const std::string_view& topic, const Context& context = Context()
  );

  /// @brief Log a message to the channel.
  ///
  /// @param msg The CompressedAudio message to log.
  /// @param log_time The timestamp of the message, as nanoseconds since epoch. If omitted, the
  /// current time is used.
  /// @param sink_id The ID of the sink to log to. If omitted, the message is logged to all sinks.
  FoxgloveError log(
    const CompressedAudio& msg, std::optional<uint64_t> log_time = std::nullopt,
    std::optional<uint64_t> sink_id = std::nullopt
  ) noexcept;
  ...
  CompressedAudioChannel(const CompressedAudioChannel& other) noexcept = delete;
  CompressedAudioChannel& operator=(const CompressedAudioChannel& other) noexcept = delete;
  /// @brief Default move constructor.
  CompressedAudioChannel(CompressedAudioChannel&& other) noexcept = default;
  /// @brief Default move assignment.
  CompressedAudioChannel& operator=(CompressedAudioChannel&& other) noexcept = default;
  /// @brief Default destructor.
  ~CompressedAudioChannel() = default;

private:
  explicit CompressedAudioChannel(ChannelUniquePtr&& channel)
      : impl_(std::move(channel)) {}
...
/// @brief A channel for logging CompressedPointCloud messages to a topic.
///
/// @note While channels are fully thread-safe, the CompressedPointCloud struct is not thread-safe.
/// Avoid modifying it concurrently or during a log operation.
...
public:
  ...
  /// @param context The context which associates logs to a sink. If omitted, the default context is
  /// used.
  static FoxgloveResult<CompressedPointCloudChannel> create(
    const std::string_view& topic, const Context& context = Context()
  );

  /// @brief Log a message to the channel.
  ///
  /// @param msg The CompressedPointCloud message to log.
  /// @param log_time The timestamp of the message, as nanoseconds since epoch. If omitted, the
  /// current time is used.
  /// @param sink_id The ID of the sink to log to. If omitted, the message is logged to all sinks.
  FoxgloveError log(
    const CompressedPointCloud& msg, std::optional<uint64_t> log_time = std::nullopt,
    std::optional<uint64_t> sink_id = std::nullopt
  ) noexcept;
  ...
  /// @brief Default move assignment.
  CompressedPointCloudChannel& operator=(CompressedPointCloudChannel&& other) noexcept = default;
  /// @brief Default destructor.
  ~CompressedPointCloudChannel() = default;

private:
  explicit CompressedPointCloudChannel(ChannelUniquePtr&& channel)
      : impl_(std::move(channel)) {}
...
/// @brief A channel for logging Event messages to a topic.
///
/// @note While channels are fully thread-safe, the Event struct is not thread-safe.
/// Avoid modifying it concurrently or during a log operation.
class EventChannel {
public:
  /// @brief Create a new channel.
  ...
  /// @param context The context which associates logs to a sink. If omitted, the default context is
  /// used.
  static FoxgloveResult<EventChannel> create(
    const std::string_view& topic, const Context& context = Context()
  );
  ...
  /// @param sink_id The ID of the sink to log to. If omitted, the message is logged to all sinks.
  FoxgloveError log(
    const Event& msg, std::optional<uint64_t> log_time = std::nullopt,
    std::optional<uint64_t> sink_id = std::nullopt
  ) noexcept;
  ...
  EventChannel(const EventChannel& other) noexcept = delete;
  EventChannel& operator=(const EventChannel& other) noexcept = delete;
  /// @brief Default move constructor.
  EventChannel(EventChannel&& other) noexcept = default;
  /// @brief Default move assignment.
  EventChannel& operator=(EventChannel&& other) noexcept = default;
  /// @brief Default destructor.
  ~EventChannel() = default;

private:
  explicit EventChannel(ChannelUniquePtr&& channel)
      : impl_(std::move(channel)) {}
...
/// @brief A channel for logging JointStates messages to a topic.
///
/// @note While channels are fully thread-safe, the JointStates struct is not thread-safe.
/// Avoid modifying it concurrently or during a log operation.
...
public:
  ...
  /// @param context The context which associates logs to a sink. If omitted, the default context is
  /// used.
  static FoxgloveResult<JointStatesChannel> create(
    const std::string_view& topic, const Context& context = Context()
  );

  /// @brief Log a message to the channel.
  ///
  /// @param msg The JointStates message to log.
  /// @param log_time The timestamp of the message, as nanoseconds since epoch. If omitted, the
  /// current time is used.
  /// @param sink_id The ID of the sink to log to. If omitted, the message is logged to all sinks.
  FoxgloveError log(
    const JointStates& msg, std::optional<uint64_t> log_time = std::nullopt,
    std::optional<uint64_t> sink_id = std::nullopt
  ) noexcept;
  ...
  /// @brief Default move constructor.
  JointStatesChannel(JointStatesChannel&& other) noexcept = default;
  /// @brief Default move assignment.
  JointStatesChannel& operator=(JointStatesChannel&& other) noexcept = default;
  /// @brief Default destructor.
  ~JointStatesChannel() = default;

private:
  explicit JointStatesChannel(ChannelUniquePtr&& channel)
      : impl_(std::move(channel)) {}
