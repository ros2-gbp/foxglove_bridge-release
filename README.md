## foxglove-sdk (humble) - 3.5.0-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Tue, 25 Aug 2026 17:32:42 -0000`
...
## foxglove-sdk (jazzy) - 3.5.0-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Tue, 25 Aug 2026 17:31:05 -0000`
...
## foxglove-sdk (kilted) - 3.5.0-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Tue, 25 Aug 2026 17:28:31 -0000`
...
## foxglove-sdk (lyrical) - 3.5.0-2

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Tue, 25 Aug 2026 17:21:29 -0000`
...
## foxglove-sdk (rolling) - 3.5.0-2

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Tue, 25 Aug 2026 17:19:38 -0000`
...
## foxglove-sdk (lyrical) - 3.5.0-1

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Tue, 25 Aug 2026 17:14:42 -0000`
...
## foxglove-sdk (rolling) - 3.5.0-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Tue, 25 Aug 2026 17:10:25 -0000`
...
## foxglove-sdk (rolling) - 3.4.3-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Wed, 22 Jul 2026 19:38:11 -0000`
...
## foxglove-sdk (lyrical) - 3.4.3-1

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Wed, 22 Jul 2026 19:36:56 -0000`
...
## foxglove-sdk (kilted) - 3.4.3-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Wed, 22 Jul 2026 19:35:34 -0000`
...
## foxglove-sdk (jazzy) - 3.4.3-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Wed, 22 Jul 2026 19:34:09 -0000`
...
## foxglove-sdk (humble) - 3.4.3-2

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Wed, 22 Jul 2026 19:32:38 -0000`
...
## foxglove-sdk (humble) - 3.4.3-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Wed, 22 Jul 2026 19:28:43 -0000`
...
## foxglove-sdk (rolling) - 3.4.2-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Thu, 25 Jun 2026 17:01:22 -0000`
...
## foxglove-sdk (lyrical) - 3.4.2-1

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Thu, 25 Jun 2026 16:44:44 -0000`
...
## foxglove-sdk (kilted) - 3.4.2-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Thu, 25 Jun 2026 16:41:54 -0000`
...
## foxglove-sdk (jazzy) - 3.4.2-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Thu, 25 Jun 2026 16:31:43 -0000`
...
## foxglove-sdk (humble) - 3.4.2-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Thu, 25 Jun 2026 16:29:13 -0000`
...
## foxglove-sdk (rolling) - 3.4.1-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Tue, 02 Jun 2026 04:05:23 -0000`
...
## foxglove-sdk (lyrical) - 3.4.1-1

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Tue, 02 Jun 2026 04:00:58 -0000`
...
## foxglove-sdk (kilted) - 3.4.1-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Tue, 02 Jun 2026 03:53:48 -0000`
...
## foxglove-sdk (jazzy) - 3.4.1-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Tue, 02 Jun 2026 03:52:41 -0000`
...
## foxglove-sdk (humble) - 3.4.1-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Tue, 02 Jun 2026 03:50:55 -0000`
...
## foxglove-sdk (rolling) - 3.4.0-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Fri, 29 May 2026 20:14:32 -0000`
...
## foxglove-sdk (lyrical) - 3.4.0-1

The packages in the `foxglove-sdk` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro lyrical` on `Fri, 29 May 2026 20:13:25 -0000`
...
## foxglove-sdk (kilted) - 3.4.0-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Fri, 29 May 2026 20:12:20 -0000`
...
## foxglove-sdk (jazzy) - 3.4.0-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Fri, 29 May 2026 20:10:55 -0000`
...
## foxglove-sdk (humble) - 3.4.0-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Fri, 29 May 2026 20:04:26 -0000`
...
## foxglove-sdk (rolling) - 3.3.0-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Fri, 01 May 2026 03:43:53 -0000`
...
## foxglove-sdk (kilted) - 3.3.0-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Fri, 01 May 2026 03:41:20 -0000`
...
## foxglove-sdk (jazzy) - 3.3.0-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Fri, 01 May 2026 03:39:22 -0000`
...
## foxglove-sdk (humble) - 3.3.0-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble -y` on `Fri, 01 May 2026 03:32:10 -0000`
...
## foxglove-sdk (kilted) - 3.2.6-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro kilted` on `Fri, 03 Apr 2026 20:13:19 -0000`
...
## foxglove-sdk (jazzy) - 3.2.6-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro jazzy` on `Fri, 03 Apr 2026 20:12:09 -0000`
...
## foxglove-sdk (humble) - 3.2.6-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro humble` on `Fri, 03 Apr 2026 20:10:44 -0000`
...
## foxglove-sdk (rolling) - 3.2.6-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove-sdk --ros-distro rolling` on `Fri, 03 Apr 2026 20:08:06 -0000`
...
## foxglove-sdk (humble) - 3.2.5-2

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove-sdk --rosdistro humble` on `Mon, 23 Mar 2026 22:43:52 -0000`
...
## foxglove-sdk (kilted) - 3.2.4-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted foxglove-sdk` on `Fri, 23 Jan 2026 17:49:11 -0000`
...
## foxglove-sdk (jazzy) - 3.2.4-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy foxglove-sdk` on `Fri, 23 Jan 2026 17:46:08 -0000`
...
## foxglove-sdk (humble) - 3.2.4-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble foxglove-sdk` on `Fri, 23 Jan 2026 01:04:26 -0000`
...
## foxglove-sdk (humble) - 3.2.3-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble foxglove-sdk` on `Mon, 12 Jan 2026 19:57:22 -0000`
...
## foxglove-sdk (jazzy) - 3.2.3-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy foxglove-sdk` on `Mon, 12 Jan 2026 19:54:49 -0000`
...
## foxglove-sdk (kilted) - 3.2.3-1

The packages in the `foxglove-sdk` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted foxglove-sdk` on `Mon, 12 Jan 2026 19:53:32 -0000`
...
## foxglove-sdk (rolling) - 3.2.3-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling foxglove-sdk` on `Mon, 12 Jan 2026 19:49:36 -0000`
...
## foxglove-sdk (humble) - 3.2.2-1

The packages in the `foxglove-sdk` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble foxglove-sdk` on `Mon, 03 Nov 2025 19:05:16 -0000`
...
## foxglove-sdk (jazzy) - 3.2.2-1

The packages in the `foxglove-sdk` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy foxglove-sdk` on `Mon, 03 Nov 2025 18:55:30 -0000`
...
## foxglove_bridge (kilted) - 3.2.1-1

The packages in the `foxglove_bridge` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --ros-distro kilted -e foxglove_bridge` on `Fri, 26 Sep 2025 19:27:15 -0000`
...
## foxglove-sdk (rolling) - 3.2.1-1

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling foxglove-sdk` on `Fri, 26 Sep 2025 19:10:02 -0000`
...
## foxglove-sdk (rolling) - 3.2.0-2

The packages in the `foxglove-sdk` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling foxglove-sdk` on `Thu, 25 Sep 2025 19:25:04 -0000`
...
## foxglove_bridge (rolling) - 3.2.0-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling foxglove_bridge -e` on `Wed, 24 Sep 2025 16:38:27 -0000`
...
## foxglove_bridge (rolling) - 0.8.5-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Thu, 15 May 2025 15:44:57 -0000`
...
The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro humble` on `Thu, 15 May 2025 15:07:43 -0000`
...
## foxglove_bridge (rolling) - 0.8.3-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Mon, 03 Feb 2025 14:54:59 -0000`
...
## foxglove_bridge (jazzy) - 0.8.3-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro jazzy` on `Mon, 03 Feb 2025 14:49:25 -0000`
...
## foxglove_bridge (humble) - 0.8.3-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro humble` on `Mon, 03 Feb 2025 14:43:55 -0000`
...
## foxglove_bridge (rolling) - 0.8.2-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro rolling -y` on `Thu, 12 Dec 2024 05:35:23 -0000`
...
## foxglove_bridge (jazzy) - 0.8.2-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro jazzy -y` on `Thu, 12 Dec 2024 05:34:25 -0000`
...
## foxglove_bridge (humble) - 0.8.2-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro humble -y` on `Thu, 12 Dec 2024 01:56:33 -0000`
...
## foxglove_bridge (humble) - 0.8.1-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro humble -y` on `Tue, 26 Nov 2024 22:55:28 -0000`
...
## foxglove_bridge (iron) - 0.8.1-1

The packages in the `foxglove_bridge` repository were released into the `iron` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro iron` on `Tue, 26 Nov 2024 22:53:59 -0000`
...
## foxglove_bridge (jazzy) - 0.8.1-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro jazzy` on `Tue, 26 Nov 2024 22:52:58 -0000`
...
## foxglove_bridge (rolling) - 0.8.1-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Tue, 26 Nov 2024 22:51:32 -0000`
...
## foxglove_bridge (rolling) - 0.8.0-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Wed, 31 Jul 2024 16:51:49 -0000`
...
## foxglove_bridge (jazzy) - 0.8.0-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro jazzy` on `Wed, 31 Jul 2024 16:47:50 -0000`
...
## foxglove_bridge (iron) - 0.8.0-1

The packages in the `foxglove_bridge` repository were released into the `iron` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro iron` on `Wed, 31 Jul 2024 16:41:23 -0000`
...
## foxglove_bridge (humble) - 0.8.0-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/usr/bin/bloom-release foxglove_bridge --rosdistro humble` on `Wed, 31 Jul 2024 16:30:43 -0000`
...
## foxglove_bridge (jazzy) - 0.7.9-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro jazzy` on `Tue, 09 Jul 2024 16:30:50 -0000`
...
## foxglove_bridge (rolling) - 0.7.9-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Tue, 09 Jul 2024 16:01:03 -0000`
...
## foxglove_bridge (iron) - 0.7.9-1

The packages in the `foxglove_bridge` repository were released into the `iron` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro iron` on `Tue, 09 Jul 2024 15:54:28 -0000`
...
## foxglove_bridge (humble) - 0.7.9-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro humble` on `Fri, 05 Jul 2024 13:18:02 -0000`
...
## foxglove_bridge (jazzy) - 0.7.7-1

The packages in the `foxglove_bridge` repository were released into the `jazzy` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro jazzy` on `Tue, 21 May 2024 21:59:53 -0000`
...
## foxglove_bridge (rolling) - 0.7.7-1

The packages in the `foxglove_bridge` repository were released into the `rolling` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro rolling` on `Tue, 21 May 2024 21:54:41 -0000`
...
## foxglove_bridge (iron) - 0.7.7-1

The packages in the `foxglove_bridge` repository were released into the `iron` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro iron` on `Tue, 21 May 2024 21:51:51 -0000`
...
## foxglove_bridge (humble) - 0.7.7-1

The packages in the `foxglove_bridge` repository were released into the `humble` distro by running `/home/vscode/.local/bin/bloom-release foxglove_bridge --rosdistro humble` on `Tue, 21 May 2024 21:45:42 -0000`
...
## foxglove_bridge (rolling) - 0.7.6-2
...
## foxglove_bridge (galactic) - 0.2.0-1
